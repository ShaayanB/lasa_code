...

{
   // method main(): program	starting	point
    ...
    System.out.println( "Trying piggyBank()"	);
		...
		System.out.println( "Invoke.piggyBank( " + p1	+ ", " +	n1	+ ", " +	d1
											   + ", "	+ q1 + ", "	+ h1 + "	):	" + c1 );
		System.out.println( "Invoke.piggyBank( " + p2	+ ", " +	n2	+ ", " +	d2
											   + ", "	+ q2 + ", "	+ h2 + "	):	" + c2 );
    ...
    System.out.println( "\nTrying mp3Sizer()" );
		...
		System.out.println( "Invoke.mp3Sizer( " + s1 + ", " + m1 + ", " + j1
											   + "	):	" + g1 );
		System.out.println( "Invoke.mp3Sizer( " + s2 + ", " + m2 + ", " + j2
											   + "	):	" + g2 );
    System.out.println();
	}
}